...
function PeopleView({ people }) {
	...
	return (
		<main id="people-view" className="h-screen overflow-auto">
			...
			<section id="section-people" className="flex flex-col justify-center px-12 pb-20 sm:pb-0 sm:px-0 mx-6 mb-4 mt-20 sm:mx-6 sm:flex-row sm:flex-wrap md:mx-10 lg:mx-40 2xl:mx-64">
				{query.get('person')
