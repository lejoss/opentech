...
function PeopleView({ people }) {
	...
	return (
		<main id="people-view" className="h-screen overflow-auto">
			<p className="text-center text-5xl lg:text-left mt-10 md:mb-6 max-w-screen-md m-auto">People</p>
			<section id="section-people" className="flex flex-col justify-center px-12 pb-20 sm:pb-0 sm:px-0 mx-6 mb-4 mt-8 sm:mx-6 sm:flex-row sm:flex-wrap">
				{query.get('person')
