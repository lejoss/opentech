...
function ProfileCard() {
	return (
		<figure className="flex flex-col profile-card m-1 py-6 px-4 bg-white sm:w-72 shadow-md rounded-md">
			<img className="my-0 mx-auto w-24 h-24" src="/images/dave.png" alt="tpp" />
			<p className="text-center leading-relaxed tracking-wide text-2xl mt-4">David Alvarez</p>
			...
			<div className="flex items-start ml-0 mb-1">
				...
				<div className="">
					<p className="leading-relaxed tracking-wide text-xs font-light">+571 3394949</p>
			...
			<div className="flex flex-1 items-start ml-0 mb-1">
				...
				<div className="">
					<p className="break-all leading-relaxed tracking-wide text-xs font-light">d.alvarezm@uniandes.edu.co</p>
