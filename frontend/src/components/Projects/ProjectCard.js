...
function ProjectCard() {
	return (
		<figure className="m-2 p-4 bg-white sm:w-64 cursor-pointer shadow-md rounded-md m-0">
			<img className="sm:w-56 h-auto border-botto" src="/images/tpp.jpeg" alt="tpp" />
			...
			<Link to="/projects/1/intro">
				<p className="text-right leading-relaxed tracking-wide text-xs uppercase mt-6 text-gray-900">learn more</p>
			</Link>
		</figure>
	);
}
